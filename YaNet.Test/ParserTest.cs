...
namespace YaNet.Test
{
    ...
    public class PeekerTest
    {
        ...
        public void CountIndentSpacesTest()
        {
            ...
            {
                Assert.Equal(yanet.peeker.IndentLevel(indent), yanet.countIndent);
            }
        }
        ...
        public void CountIndentExceptionTest()
        {
            ...
            Assert.Throws<Exception>(new Action(() => new Peeker("   ").IndentLevel(indent))); // 3
            Assert.Throws<Exception>(new Action(() => new Peeker("    ").IndentLevel(indent)));// 4
        }
